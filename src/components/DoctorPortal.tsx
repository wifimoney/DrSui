...
// @ts-ignore - ZKVerificationDashboard is a JSX file
...
export function DoctorPortal() {
      ...
      try {
        ...
        if (payload.type === 'package_event') {
          ...
          if (eventTypeString && eventTypeString.includes(`${package_id}::doctor::add_doctor_request`)) {
            ...
            // setShowRequestToast(true); // Disabled - toast component is commented out
  ...
  // Handlers for patient request toast (currently disabled)
