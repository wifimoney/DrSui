...
import {
  ...
  useQuery,
  useSuspenseQuery
} from "./chunk-5X3KP734.js";
import {
  Slot
} from "./chunk-GTF7DNNX.js";
import {
  Ed25519Keypair
} from "./chunk-X23HHBFV.js";
import {
  getFullnodeUrl
} from "./chunk-Y5GLUUIE.js";
import "./chunk-AJRQNHMD.js";
import {
  SuiJsonRpcClient,
  isSuiJsonRpcClient
} from "./chunk-OUFYDBKT.js";
import "./chunk-4EPMACS5.js";
import {
  Transaction
} from "./chunk-NFD2VXTC.js";
import {
  array,
  boolean,
  lazy,
  ...
  uuid,
  variant
} from "./chunk-2646PJ25.js";
import {
  formatAddress,
  fromBase64,
  promiseWithResolvers,
  toBase64
} from "./chunk-IH5GPGPB.js";
import {
  Content2,
  Item2,
  Portal2,
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React3 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState4 = React3.useState, useEffect4 = React3.useEffect, useLayoutEffect3 = React3.useLayoutEffect, useDebugValue2 = React3.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React3 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef3 = React3.useRef, useEffect4 = React3.useEffect, useMemo3 = React3.useMemo, useDebugValue2 = React3.useDebugValue;
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime2.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React2.Children.map(children, (child) => (0, import_jsx_runtime2.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime2.jsx)(Portal, { asChild: true, container: container8, children: child }) })) });
};
...
var DialogOverlayImpl = React2.forwardRef(
  (props, forwardedRef) => {
    ...
    return (
      ...
      (0, import_jsx_runtime2.jsx)(Combination_default, { as: Slot3, allowPinchZoom: true, shards: [context.contentRef], children: (0, import_jsx_runtime2.jsx)(
        Primitive.div,
        {
          "data-state": getState(context.open),
          ...overlayProps,
...
function register(...wallets2) {
  ...
  (_a5 = listeners["register"]) == null ? void 0 : _a5.forEach((listener) => guard(() => listener(...wallets2)));
  return function unregister() {
    var _a6;
    wallets2.forEach((wallet) => removeRegisteredWallet(wallet));
    (_a6 = listeners["unregister"]) == null ? void 0 : _a6.forEach((listener) => guard(() => listener(...wallets2)));
  };
}
...
function on(event, listener) {
  var _a5;
  ((_a5 = listeners[event]) == null ? void 0 : _a5.push(listener)) || (listeners[event] = [listener]);
  return function off() {
    var _a6;
    listeners[event] = (_a6 = listeners[event]) == null ? void 0 : _a6.filter((existingListener) => listener !== existingListener);
  };
}
...
var DappPostMessageChannel = class {
  constructor({
    ...
    __privateAdd2(this, _DappPostMessageChannel_instances);
    __privateAdd2(this, _popup);
    __privateAdd2(this, _version, "1");
    __privateAdd2(this, _id);
    __privateAdd2(this, _hostOrigin);
    __privateAdd2(this, _hostPathname);
    __privateAdd2(this, _appName);
    __privateAdd2(this, _extraRequestOptions);
    __privateAdd2(this, _promise);
    __privateAdd2(this, _resolve);
    __privateAdd2(this, _reject);
    __privateAdd2(this, _interval, null);
    __privateAdd2(this, _isSendCalled2, false);
    __privateAdd2(this, _listener, (event) => {
      if (event.origin !== __privateGet2(this, _hostOrigin)) {
        return;
      }
      const { success, output } = safeParse(Response, event.data);
      if (!success || output.id !== __privateGet2(this, _id)) {
        return;
      }
      __privateMethod2(this, _DappPostMessageChannel_instances, cleanup_fn).call(this);
      if (output.payload.type === "reject") {
        __privateGet2(this, _reject).call(this, new Error("User rejected the request"));
      } else if (output.payload.type === "resolve") {
        __privateGet2(this, _resolve).call(this, output.payload.data);
      }
    });
    ...
    __privateSet2(this, _popup, popup);
    __privateSet2(this, _hostOrigin, hostOrigin);
    __privateSet2(this, _hostPathname, hostPathname);
    __privateSet2(this, _appName, appName);
    const { promise, resolve, reject } = promiseWithResolvers();
    __privateSet2(this, _promise, promise);
    __privateSet2(this, _resolve, resolve);
    __privateSet2(this, _reject, reject);
    __privateSet2(this, _extraRequestOptions, extraRequestOptions);
    __privateSet2(this, _interval, setInterval(() => {
      try {
        if (__privateGet2(this, _popup).closed) {
          __privateMethod2(this, _DappPostMessageChannel_instances, cleanup_fn).call(this);
  ...
  send({
    ...
    if (__privateGet2(this, _isSendCalled2)) {
      throw new Error("send() can only be called once");
    }
    __privateSet2(this, _isSendCalled2, true);
    window.addEventListener("message", __privateGet2(this, _listener));
    const requestData = {
      version: __privateGet2(this, _version),
      requestId: __privateGet2(this, _id),
      appUrl: window.location.href.split("#")[0],
      appName: __privateGet2(this, _appName),
      payload: {
        type,
        ...data
      },
      metadata: getClientMetadata(),
      extraRequestOptions: __privateGet2(this, _extraRequestOptions)
    };
    const encodedRequestData = encodeURIComponent(btoa(JSON.stringify(requestData)));
    __privateGet2(this, _popup).location.assign(`${__privateGet2(this, _hostOrigin)}/${__privateGet2(this, _hostPathname)}#${encodedRequestData}`);
    return __privateGet2(this, _promise);
  }
  close() {
    __privateMethod2(this, _DappPostMessageChannel_instances, cleanup_fn).call(this);
    __privateGet2(this, _popup).close();
  }
};
...
cleanup_fn = function() {
  if (__privateGet2(this, _interval)) {
    clearInterval(__privateGet2(this, _interval));
    __privateSet2(this, _interval, null);
  }
  window.removeEventListener("message", __privateGet2(this, _listener));
};
...
var SlushWallet = class {
  constructor({
    ...
    __privateAdd3(this, _SlushWallet_instances);
    __privateAdd3(this, _id2);
    __privateAdd3(this, _events);
    __privateAdd3(this, _accounts);
    __privateAdd3(this, _origin);
    __privateAdd3(this, _walletName);
    __privateAdd3(this, _icon);
    __privateAdd3(this, _name);
    __privateAdd3(this, _signTransactionBlock, async ({
      transactionBlock,
      account,
      chain
    }) => {
      const data = await transactionBlock.toJSON();
      const popup = __privateMethod3(this, _SlushWallet_instances, getNewPopupChannel_fn).call(this);
    ...
    __privateAdd3(this, _signTransaction, async ({ transaction, account, chain }) => {
      const popup = __privateMethod3(this, _SlushWallet_instances, getNewPopupChannel_fn).call(this);
    ...
    __privateAdd3(this, _signAndExecuteTransaction, async ({
      transaction,
      account,
      chain
    }) => {
    ...
    __privateAdd3(this, _signPersonalMessage, async ({ message, account, chain }) => {
      const popup = __privateMethod3(this, _SlushWallet_instances, getNewPopupChannel_fn).call(this);
      const response = await popup.send({
    ...
    __privateAdd3(this, _connect, async (input) => {
      ...
      __privateMethod3(this, _SlushWallet_instances, setAccounts_fn).call(this, getAccountsFromSession(response.session));
      return { accounts: this.accounts };
    });
    __privateAdd3(this, _disconnect, async () => {
      localStorage.removeItem(SLUSH_SESSION_KEY);
      __privateMethod3(this, _SlushWallet_instances, setAccounts_fn).call(this, []);
    });
    __privateSet3(this, _id2, metadata.id);
    __privateSet3(this, _accounts, __privateMethod3(this, _SlushWallet_instances, getPreviouslyAuthorizedAccounts_fn).call(this));
    __privateSet3(this, _events, mitt_default());
    __privateSet3(this, _origin, origin || DEFAULT_SLUSH_ORIGIN);
    __privateSet3(this, _name, name);
    __privateSet3(this, _walletName, metadata.walletName);
    __privateSet3(this, _icon, metadata.icon);
  }
  get name() {
    return __privateGet3(this, _walletName);
  }
  get id() {
    return __privateGet3(this, _id2);
  }
  get icon() {
    return __privateGet3(this, _icon);
  }
  get version() {
    return "1.0.0";
  }
  ...
  get features() {
    return {
      ...
      "sui:signTransaction": {
        version: "2.0.0",
        signTransaction: __privateGet3(this, _signTransaction)
      },
      "sui:signPersonalMessage": {
        version: "1.1.0",
      ...
      "sui:signAndExecuteTransaction": {
        version: "2.0.0",
        signAndExecuteTransaction: __privateGet3(this, _signAndExecuteTransaction)
      }
    };
  }
...
setAccounts_fn = function(accounts) {
  __privateSet3(this, _accounts, accounts);
...
getNewPopupChannel_fn = function() {
  return new DappPostMessageChannel({
    appName: __privateGet3(this, _name),
    hostOrigin: __privateGet3(this, _origin)
  });
};
...
var oldImpl = (config, baseOptions) => (set, get3, api) => {
  ...
  const hydrate = () => {
    ...
    const postRehydrationCallback = ((_a5 = options.onRehydrateStorage) == null ? void 0 : _a5.call(options, get3())) || void 0;
...
var newImpl = (config, baseOptions) => (set, get3, api) => {
  ...
  const hydrate = () => {
    ...
    const postRehydrationCallback = ((_b4 = options.onRehydrateStorage) == null ? void 0 : _b4.call(options, (_a5 = get3()) != null ? _a5 : configResult)) || void 0;
...
function BackIcon(props) {
  return (0, import_jsx_runtime3.jsx)("svg", { width: 24, height: 24, fill: "none", xmlns: "http://www.w3.org/2000/svg", ...props, children: (0, import_jsx_runtime3.jsx)(
    "path",
    {
...
function CloseIcon(props) {
  return (0, import_jsx_runtime4.jsx)("svg", { width: 10, height: 10, fill: "none", xmlns: "http://www.w3.org/2000/svg", ...props, children: (0, import_jsx_runtime4.jsx)(
    "path",
    {
...
var StyleMarker = (0, import_react5.forwardRef)(({ children, ...props }, forwardedRef) => (0, import_jsx_runtime5.jsx)(Slot, { ref: forwardedRef, ...props, ...styleDataAttribute, children }));
...
var IconButton = (0, import_react7.forwardRef)(
  ({ className, asChild = false, ...props }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime7.jsx)(Comp, { ...props, className: clsx_default(container, className), ref: forwardedRef });
  }
);
  ...
  ({
    ...
    return (0, import_jsx_runtime9.jsx)(
      Slot,
      {
        ...
        children: asChild ? children : (0, import_jsx_runtime9.jsx)(Tag, { children })
      }
    );
  }
);
...
function ConnectionStatus({
  ...
  return (0, import_jsx_runtime10.jsxs)("div", { className: container2, children: [
    selectedWallet.icon && (0, import_jsx_runtime10.jsx)(
      "img",
      {
    ...
    (0, import_jsx_runtime10.jsx)("div", { className: title2, children: (0, import_jsx_runtime10.jsxs)(Heading, { as: "h2", size: "xl", children: [
      "Opening ",
      selectedWallet.name
    ] }) }),
    (0, import_jsx_runtime10.jsx)("div", { className: connectionStatus, children: hadConnectionError ? (0, import_jsx_runtime10.jsx)(Text, { color: "danger", children: "Connection failed" }) : (0, import_jsx_runtime10.jsx)(Text, { color: "muted", children: "Confirm connection in the wallet..." }) }),
    hadConnectionError ? (0, import_jsx_runtime10.jsx)("div", { className: retryButtonContainer, children: (0, import_jsx_runtime10.jsx)(Button, { type: "button", variant: "outline", onClick: () => onRetryConnection(selectedWallet), children: "Retry Connection" }) }) : null
  ] });
}
var container3 = "InfoSection_container__1wtioi70";
function InfoSection({ title: title3, children }) {
  return (0, import_jsx_runtime11.jsxs)("section", { className: container3, children: [
    (0, import_jsx_runtime11.jsx)(Heading, { as: "h3", size: "sm", weight: "normal", children: title3 }),
    (0, import_jsx_runtime11.jsx)(Text, { weight: "medium", color: "muted", children })
  ] });
}
...
function GettingStarted() {
  return (0, import_jsx_runtime12.jsxs)("div", { className: container4, children: [
    (0, import_jsx_runtime12.jsx)(Heading, { as: "h2", children: "Get Started with Sui" }),
    (0, import_jsx_runtime12.jsxs)("div", { className: content2, children: [
      (0, import_jsx_runtime12.jsx)(InfoSection, { title: "Install the Sui Wallet Extension", children: "We recommend pinning Sui Wallet to your taskbar for quicker access." }),
      (0, import_jsx_runtime12.jsx)(InfoSection, { title: "Create or Import a Wallet", children: "Be sure to back up your wallet using a secure method. Never share your secret phrase with anyone." }),
      (0, import_jsx_runtime12.jsx)(InfoSection, { title: "Refresh Your Browser", children: "Once you set up your wallet, refresh this window browser to load up the extension." }),
      (0, import_jsx_runtime12.jsx)("div", { className: installButtonContainer, children: (0, import_jsx_runtime12.jsx)(Button, { variant: "outline", asChild: true, children: (0, import_jsx_runtime12.jsx)(
        "a",
        {
...
function WhatIsAWallet() {
  return (0, import_jsx_runtime13.jsxs)("div", { className: container5, children: [
    (0, import_jsx_runtime13.jsx)(Heading, { as: "h2", children: "What is a Wallet" }),
    (0, import_jsx_runtime13.jsxs)("div", { className: content3, children: [
      (0, import_jsx_runtime13.jsx)(InfoSection, { title: "Easy Login", children: "No need to create new accounts and passwords for every website. Just connect your wallet and get going." }),
      (0, import_jsx_runtime13.jsx)(InfoSection, { title: "Store your Digital Assets", children: "Send, receive, store, and display your digital assets like NFTs & coins." })
    ] })
  ] });
}
function SuiIcon(props) {
  return (0, import_jsx_runtime14.jsxs)("svg", { width: 28, height: 28, fill: "none", xmlns: "http://www.w3.org/2000/svg", ...props, children: [
    (0, import_jsx_runtime14.jsx)("rect", { width: 28, height: 28, rx: 6, fill: "#6FBCF0" }),
...
function WalletListItem({ name, icon, onClick, isSelected = false }) {
  return (0, import_jsx_runtime15.jsx)("li", { className: container7, children: (0, import_jsx_runtime15.jsxs)(
    "button",
    {
      ...
      onClick,
      children: [
        icon && typeof icon === "string" ? (0, import_jsx_runtime15.jsx)("img", { className: walletIcon2, src: icon, alt: `${name} logo` }) : icon,
        (0, import_jsx_runtime15.jsx)(Heading, { size: "md", truncate: true, asChild: true, children: (0, import_jsx_runtime15.jsx)("div", { children: name }) })
      ]
    }
  ) });
}
function WalletList({
  ...
  return (0, import_jsx_runtime16.jsx)("ul", { className: container6, children: wallets2.length > 0 ? wallets2.map((wallet) => (0, import_jsx_runtime16.jsx)(
    WalletListItem,
    {
      name: wallet.name,
      icon: wallet.icon,
    ...
    {
      name: "Sui Wallet",
      icon: (0, import_jsx_runtime16.jsx)(SuiIcon, {}),
...
function ConnectModal({
  ...
  switch (currentView) {
    case "what-is-a-wallet":
      modalContent = (0, import_jsx_runtime17.jsx)(WhatIsAWallet, {});
      break;
    case "getting-started":
      modalContent = (0, import_jsx_runtime17.jsx)(GettingStarted, {});
      break;
    case "connection-status":
      modalContent = (0, import_jsx_runtime17.jsx)(
        ConnectionStatus,
        {
          selectedWallet,
  ...
  return (0, import_jsx_runtime17.jsxs)(Root, { open: open ?? isModalOpen, onOpenChange: handleOpenChange, children: [
    (0, import_jsx_runtime17.jsx)(Trigger2, { asChild: true, children: trigger }),
    (0, import_jsx_runtime17.jsx)(Portal3, { children: (0, import_jsx_runtime17.jsx)(StyleMarker, { children: (0, import_jsx_runtime17.jsx)(Overlay, { className: overlay, children: (0, import_jsx_runtime17.jsxs)(Content, { className: content, "aria-describedby": void 0, children: [
      (0, import_jsx_runtime17.jsxs)(
        "div",
        {
          ...
          children: [
            (0, import_jsx_runtime17.jsxs)("div", { className: walletListContent, children: [
              (0, import_jsx_runtime17.jsx)(Title, { className: title, asChild: true, children: (0, import_jsx_runtime17.jsx)(Heading, { as: "h2", children: "Connect a Wallet" }) }),
      ...
      (0, import_jsx_runtime17.jsxs)(
        "div",
        {
          ...
          children: [
            (0, import_jsx_runtime17.jsx)("div", { className: backButtonContainer, children: (0, import_jsx_runtime17.jsx)(IconButton, { type: "button", "aria-label": "Back", onClick: () => resetSelection(), children: (0, import_jsx_runtime17.jsx)(BackIcon, {}) }) }),
            modalContent
          ]
        }
      ),
      (0, import_jsx_runtime17.jsx)(Close, { className: closeButtonContainer, asChild: true, children: (0, import_jsx_runtime17.jsx)(IconButton, { type: "button", "aria-label": "Close", children: (0, import_jsx_runtime17.jsx)(CloseIcon, {}) }) })
    ] }) }) }) })
  ] });
}
...
function SuiClientProvider(props) {
  ...
  return (0, import_jsx_runtime18.jsx)(SuiClientContext.Provider, { value: ctx, children });
}
...
function CheckIcon(props) {
  return (0, import_jsx_runtime19.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none", ...props, children: (0, import_jsx_runtime19.jsx)(
    "path",
    {
      fill: "currentColor",
...
function ChevronIcon(props) {
  return (0, import_jsx_runtime20.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none", ...props, children: (0, import_jsx_runtime20.jsx)(
    "path",
    {
      stroke: "#A0B6C3",
      strokeLinecap: "round",
...
function AccountDropdownMenu({ currentAccount }) {
  ...
  return (0, import_jsx_runtime21.jsxs)(Root2, { modal: false, children: [
    (0, import_jsx_runtime21.jsx)(StyleMarker, { children: (0, import_jsx_runtime21.jsx)(Trigger, { asChild: true, children: (0, import_jsx_runtime21.jsxs)(Button, { size: "lg", className: connectedAccount, children: [
      (0, import_jsx_runtime21.jsx)(Text, { mono: true, weight: "bold", children: currentAccount.label ?? domain ?? formatAddress(currentAccount.address) }),
      (0, import_jsx_runtime21.jsx)(ChevronIcon, {})
    ] }) }) }),
    (0, import_jsx_runtime21.jsx)(Portal2, { children: (0, import_jsx_runtime21.jsx)(StyleMarker, { className: menuContainer, children: (0, import_jsx_runtime21.jsxs)(Content2, { className: menuContent, children: [
      accounts.map((account) => (0, import_jsx_runtime21.jsx)(
      ...
      (0, import_jsx_runtime21.jsx)(Separator2, { className: separator }),
...
function AccountDropdownMenuItem({
  ...
  return (0, import_jsx_runtime21.jsxs)(
    Item2,
    {
      ...
      children: [
        (0, import_jsx_runtime21.jsx)(Text, { mono: true, children: account.label ?? domain ?? formatAddress(account.address) }),
        active ? (0, import_jsx_runtime21.jsx)(CheckIcon, {}) : null
      ]
    }
  );
}
function ConnectButton({
  ...
  return currentAccount ? (0, import_jsx_runtime22.jsx)(AccountDropdownMenu, { currentAccount }) : (0, import_jsx_runtime22.jsx)(
    ConnectModal,
    {
      walletFilter,
      trigger: (0, import_jsx_runtime22.jsx)(StyleMarker, { children: (0, import_jsx_runtime22.jsx)(Button, { ...buttonProps, children: connectText }) })
    }
  );
}
...
function registerUnsafeBurnerWallet(suiClient) {
  ...
  class UnsafeBurnerWallet {
    constructor() {
      ...
      __privateAdd4(this, _signAndExecuteTransaction2, async (transactionInput) => {
        var _a5;
        const { bytes, signature } = await Transaction.from(
          await transactionInput.transaction.toJSON()
        ).sign({
        ...
        (_a5 = transactionInput.signal) == null ? void 0 : _a5.throwIfAborted();
        const { rawEffects, digest: digest2 } = await suiClient.executeTransactionBlock({
          signature,
          transactionBlock: bytes,
          options: {
            showRawEffects: true
    ...
    get features() {
      return {
        ...
        "sui:signTransaction": {
          version: "2.0.0",
          signTransaction: __privateGet4(this, _signTransaction2)
        },
        "sui:signAndExecuteTransaction": {
          version: "2.0.0",
          signAndExecuteTransaction: __privateGet4(this, _signAndExecuteTransaction2)
        }
      };
    }
  }
...
function WalletProvider({
  ...
  return (0, import_jsx_runtime24.jsx)(WalletContext.Provider, { value: storeRef.current, children: (0, import_jsx_runtime24.jsxs)(
    WalletConnectionManager,
    {
      ...
      slushWallet,
      children: [
        theme ? (0, import_jsx_runtime24.jsx)(InjectedThemeStyles, { theme }) : null,
        children
      ]
    }
  ) });
...
function useSignAndExecuteTransaction({
  ...
  const executeTransaction = execute ?? (async ({ bytes, signature }) => {
    const { digest: digest2, rawEffects } = await client.executeTransactionBlock({
      transactionBlock: bytes,
      signature,
      options: {
        showRawEffects: true
